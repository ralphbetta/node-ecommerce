...
const { createUser, loginUser, getAllUsers, getUser, deleteUser, updateUser, getProfile, deleteProfile, updateProfile, blockUser, unblockUser } = require('../controller/userController');
